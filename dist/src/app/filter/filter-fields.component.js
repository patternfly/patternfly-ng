...
FilterFieldsComponent = __decorate([
    Component({
        ...
        styles: [".filter-pf a{cursor:pointer}.filter-pf.filter-fields .form-group{padding-left:0;width:275px}.filter-pf.filter-fields .btn-default{font-size:12px}.filter-pf.filter-fields .typeahead-input-container{position:relative;padding-right:0}.filter-pf.filter-fields .typeahead-input-container .caret{position:absolute;top:10px;right:5px;z-index:2}.filter-select .btn-default{background-color:#fff;background-image:none;color:#8b8d8f;font-size:12px;font-style:italic;font-weight:400}.filter-select .avatar{height:20px;margin-right:5px}.input-group .input-group-btn .dropdown-menu>.selected>a{background-color:#0088ce!important;border-color:#0088ce!important;color:#fff}"],
