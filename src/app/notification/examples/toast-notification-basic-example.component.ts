...
@Component({
  ...
  selector: 'toast-notification-basic-example',
  templateUrl: './toast-notification-basic-example.component.html'
})
export class ToastNotificationBasicExampleComponent implements OnInit {
  actionText: string = '';
