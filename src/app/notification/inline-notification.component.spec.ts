...
describe('Inline notification component - ', () => {
  ...
  it('should have the inner text set correctly', () => {
    ...
    fixture.detectChanges();
    const results = fixture.debugElement.query(By.css('.alert'));
    expect(results).not.toBeNull();
    expect(results.nativeElement.textContent.trim()).toContain(comp.message);

    const header = fixture.debugElement.query(By.css('.alert strong'));
  ...
  it('close button should hide', () => {
    const initial = fixture.debugElement.query(By.css('.alert'));
    expect(initial).not.toBeNull();

    comp.dismissable = true;
    fixture.detectChanges();

    const fields = fixture.debugElement.query(By.css('.alert button'));
  ...
  it('type should display correctly', () => {
    ...
    fixture.detectChanges();
    const results = fixture.debugElement.query(By.css('.pficon-ok'));
    expect(results).not.toBeNull();

    comp.type = NotificationType.INFO;
    fixture.detectChanges();
    const infoResults = fixture.debugElement.query(By.css('.pficon-info'));
    expect(infoResults).not.toBeNull();

    comp.type = NotificationType.WARNING;
    fixture.detectChanges();
    const warningResults = fixture.debugElement.query(By.css('.pficon-warning-triangle-o'));

    expect(warningResults).not.toBeNull();

    comp.type = NotificationType.DANGER;
    fixture.detectChanges();
    const dangerResults = fixture.debugElement.query(By.css('.pficon-error-circle-o'));
