...
describe('Action component - ', () => {
  ...
  beforeEach(
    async(() => {
      TestBed.configureTestingModule({
        imports: [BsDropdownModule.forRoot(), BrowserAnimationsModule, FormsModule, TooltipModule.forRoot()],
  ...
  it('should have correct number of primary actions', function() {
    const fields = fixture.debugElement.queryAll(By.css('.primary-action'));
    expect(fields.length).toBe(2);
  });

  it('should have correct number of secondary actions', function() {
    fixture.detectChanges(); // Workaround to fix dropdown tests
    const fields = fixture.debugElement.queryAll(By.css('.secondary-action'));
    expect(fields.length).toBe(6);
  });

  it('should have correct number of separators', function() {
    fixture.detectChanges(); // Workaround to fix dropdown tests
    const fields = fixture.debugElement.queryAll(By.css('.divider'));
    expect(fields.length).toBe(1);
  });

  it('should correctly disable actions', function() {
    fixture.detectChanges(); // Workaround to fix dropdown tests
    const fields = fixture.debugElement.queryAll(By.css('.disabled'));
    expect(fields.length).toBe(1);
  });
  ...
  it('should call the action function with the appropriate action when an action is clicked', function(done) {
    fixture.detectChanges(); // Workaround to fix dropdown tests
    const primaryActions = fixture.debugElement.queryAll(By.css('.primary-action'));
    const moreActions = fixture.debugElement.queryAll(By.css('.secondary-action'));
