...
describe('Toolbar component - ', () => {
  ...
  it('should have correct number of filter fields', function() {
    ...
    const fields = fixture.debugElement.queryAll(By.css('.filter-field'));
  ...
  it('should show the correct view selection buttons', function() {
    const listSelectora = fixture.debugElement.queryAll(By.css('.toolbar-pf-view-selector .btn-link'));
  ...
  it('should show the currently selected view', function() {
    const viewSelector = fixture.debugElement.query(By.css('.toolbar-pf-view-selector'));
  ...
  it('should call the callback function when a view selector clicked', function(done) {
    const listSelectors = fixture.debugElement.queryAll(By.css('.toolbar-pf-view-selector .btn-link'));
  ...
  it('should have correct number of primary actions', function() {
    const fields = fixture.debugElement.queryAll(By.css('.toolbar-pf-actions .primary-action'));
    expect(fields.length).toBe(2);
  });

  it('should have correct number of secondary actions', function() {
    fixture.detectChanges(); // Workaround to fix dropdown tests
    const fields = fixture.debugElement.queryAll(By.css('.toolbar-pf-actions .secondary-action'));
    expect(fields.length).toBe(6);
  });

  it('should have correct number of separators', function() {
    fixture.detectChanges(); // Workaround to fix dropdown tests
    const fields = fixture.debugElement.queryAll(By.css('.toolbar-pf-actions .divider'));
    expect(fields.length).toBe(1);
  });

  it('should correctly disable actions', function() {
    fixture.detectChanges(); // Workaround to fix dropdown tests
    const fields = fixture.debugElement.queryAll(By.css('.toolbar-pf-actions .disabled'));
    expect(fields.length).toBe(1);
  });
  ...
  it('should call the action function with the appropriate action when an action is clicked', function(done) {
    fixture.detectChanges(); // Workaround to fix dropdown tests
    const primaryActions = fixture.debugElement.queryAll(By.css('.toolbar-pf-actions .primary-action'));
    const moreActions = fixture.debugElement.queryAll(By.css('.toolbar-pf-actions .secondary-action'));
