...
describe('Card component - ', () => {
  ...
  it('should have a body', function() {
    const element = fixture.debugElement.queryAll(By.css('.card-pf-body'));
    expect(element.length).toBe(1);
  });

  it('should have a footer', function() {
    const element = fixture.debugElement.queryAll(By.css('.card-pf-footer'));
    expect(element.length).toBe(1);
  });
  ...
  it('should have a header', function() {
    const element = fixture.debugElement.queryAll(By.css('.card-pf-heading'));
    expect(element.length).toBe(1);
  });

  it('should have a top border', function() {
    const element = fixture.debugElement.queryAll(By.css('.card-pf-accented'));
    expect(element.length).toBe(1);
  });
  ...
  it('should have a title', function() {
    const element = fixture.debugElement.queryAll(By.css('.card-pf-title'));
    expect(element.length).toBe(1);
  });

  it('should have a sub-title', function() {
    const element = fixture.debugElement.queryAll(By.css('.card-pf-subtitle'));
    expect(element.length).toBe(1);
  });
  ...
  it('should have a filter menu', function() {
    const element = fixture.debugElement.queryAll(By.css('.card-pf-time-frame-filter'));
    expect(element.length).toBe(1);
  });

  it('should call function when filter is selected', function(done) {
    fixture.detectChanges(); // Workaround to fix dropdown tests
    const elements = fixture.debugElement.queryAll(By.css('.card-pf-time-frame-filter .dropdown-item'));
  ...
  it('should have an action', function() {
    const element = fixture.debugElement.queryAll(By.css('.card-pf-link-with-icon'));
    expect(element.length).toBe(1);
  });

  it('should call function when an action is clicked', function(done) {
    const element = fixture.debugElement.query(By.css('.card-pf-link-with-icon'));
